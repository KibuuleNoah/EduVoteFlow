...
from VoteFlow.models import School, Poll, Student, Candidate, User
from VoteFlow.auth.forms import SchoolLogin, SchoolRegister
...
def school_login():
    ...
    return render_template(
        "auth/school-login.html", title="Login - VoteFlow", form=form
    )
...
def school_register():
    ...
    return render_template(
        "auth/school-register.html", title="Register - VoteFlow", form=form
    )
